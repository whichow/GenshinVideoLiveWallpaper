...
public class VideoLiveWallpaper extends WallpaperService {
    ...
    public static final String VIDEO_PARAMS_CONTROL_ACTION = "com.genshin.livewallpaper";
...
//                    Log.d("VideoLiveWallpaper", list[i]);
//                }
                SharedPreferences sharedPreferences = getSharedPreferences("LWP", Context.MODE_MULTI_PROCESS);
                String videoFile = sharedPreferences.getString("videoFile", "");
                AssetFileDescriptor descriptor = getAssets().openFd(videoFile);
